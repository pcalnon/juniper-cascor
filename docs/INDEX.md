...
| Document | Description |
|----------|-------------|
| [REST and WebSocket API Reference](api/JUNIPER_CASCOR_API_REFERENCE.md) | Maintained service API documentation with REST endpoints, WebSocket protocols, close codes, worker in-flight task recovery, and operational constraints |
