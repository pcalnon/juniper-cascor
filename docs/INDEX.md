...
| Document | Description |
|----------|-------------|
| [REST and WebSocket API Reference](api/JUNIPER_CASCOR_API_REFERENCE.md) | Maintained service API documentation with REST endpoints, WebSocket protocols, close codes, middleware / CR-024 body limits, and operational constraints |
