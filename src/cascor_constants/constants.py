...
from cascor_constants.constants_candidates.constants_candidates import _PROJECT_MODEL_CANDIDATE_DISPLAY_FREQUENCY, _PROJECT_MODEL_CANDIDATE_EARLY_STOPPING, _PROJECT_MODEL_CANDIDATE_EPOCHS, _PROJECT_MODEL_CANDIDATE_PATIENCE, _PROJECT_MODEL_CANDIDATE_POOL_SIZE, _PROJECT_MODEL_CANDIDATE_UNIT_LEARNING_RATE, _PROJECT_MODEL_DISPLAY_FREQUENCY
...
_CASCADE_CORRELATION_NETWORK_CANDIDATE_PATIENCE = _PROJECT_MODEL_CANDIDATE_PATIENCE
_CASCADE_CORRELATION_NETWORK_CANDIDATE_CONVERGENCE_THRESHOLD = _PROJECT_MODEL_CANDIDATE_CONVERGENCE_THRESHOLD
