...
_JUNIPER_CASCOR_API_WORKER_HEARTBEAT_TIMEOUT: float = 30.0
_JUNIPER_CASCOR_API_WORKER_HEARTBEAT_TIMEOUT_DEFAULT: float = _JUNIPER_CASCOR_API_WORKER_HEARTBEAT_TIMEOUT

_JUNIPER_CASCOR_API_WORKER_TASK_REASSIGNMENT_TIMEOUT: float = 120.0
_JUNIPER_CASCOR_API_WORKER_TASK_REASSIGNMENT_TIMEOUT_DEFAULT: float = _JUNIPER_CASCOR_API_WORKER_TASK_REASSIGNMENT_TIMEOUT
...
class Settings(BaseSettings):
    ...
    worker_heartbeat_timeout: float = _JUNIPER_CASCOR_API_WORKER_HEARTBEAT_TIMEOUT_DEFAULT
    worker_task_reassignment_timeout: float = _JUNIPER_CASCOR_API_WORKER_TASK_REASSIGNMENT_TIMEOUT_DEFAULT
