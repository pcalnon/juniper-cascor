...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(("test_isolated",), {}, None, "register-method-happy-path"),
        pytest.param(("test_with_callable",), {"callable": _test_callable}, None, "register-method-with-callable"),
        pytest.param((None,), {}, TypeError, "register-method-none-name"),
        pytest.param((), {}, TypeError, "register-method-missing-args"),
    ],
)
