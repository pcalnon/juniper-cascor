...
class TestEarlyStopping:
    ...
    def test_check_patience_improved(self, simple_network):
        ...
        patience_exhausted, counter, best = simple_network.check_patience(patience_counter=5, value_loss=0.1, best_value_loss=0.2)
    ...
    def test_check_patience_exhausted(self, simple_network):
        ...
        simple_network.patience = 3
        patience_exhausted, counter, best = simple_network.check_patience(patience_counter=2, value_loss=0.3, best_value_loss=0.2)
...
class TestResidualError:
    ...
    def test_calculate_residual_error_safe_empty(self, simple_network):
        ...
        result = simple_network._calculate_residual_error_safe(x_train=torch.empty(0, 2), y_train=torch.empty(0, 2))
        assert result is None
...
class TestFactoryMethods:
    ...
    def test_create_simple_network(self):
        ...
        network = CascadeCorrelationNetwork.create_simple_network(input_size=4, output_size=3, learning_rate=0.05, max_hidden_units=15)
