...
def main():
    ...
    network = CascadeCorrelationNetwork(input_size=2, output_size=1, candidate_pool_size=2, candidate_epochs=2, candidate_learning_rate=0.01, learning_rate=0.01, log_level_name="ERROR")  # Just 2 candidates  # Just 2 epochs  # Minimal logging
