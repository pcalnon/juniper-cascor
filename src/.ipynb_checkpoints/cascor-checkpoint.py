...
from constants.constants import _CASCOR_ACTIVATION_FUNCTION, _CASCOR_CANDIDATE_EPOCHS, _CASCOR_CANDIDATE_POOL_SIZE, _CASCOR_CORRELATION_THRESHOLD, _CASCOR_INPUT_SIZE, _CASCOR_LEARNING_RATE, _CASCOR_MAX_HIDDEN_UNITS, _CASCOR_OUTPUT_EPOCHS, _CASCOR_OUTPUT_SIZE, _CASCOR_PATIENCE
