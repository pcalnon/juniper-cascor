...
| ------- | ----------- | ---------------------------- | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| CAN-000 | Canopy      | Dashboard: Meta Param Menu   | Meta Param updates pause    | Periodic updates to the Learning Rate, Hidden Units, max Epochs meta param fields should pause when the Apply Parameters button becomes active.                                            |
...
| CAS-010 | Cascor      | Cascor: Snapshot Vector DB       | Store Snapshots in Vector DB | store cascor snapshots in vector db, indexed by network uuid                                                                                                                      |
