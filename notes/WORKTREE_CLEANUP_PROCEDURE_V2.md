...
- The main repo directory is accessible at `/home/pcalnon/Development/python/Juniper/juniper-cascor`
...
# Main repo
MAIN_REPO="/home/pcalnon/Development/python/Juniper/juniper-cascor"
```
...
gh pr create --repo pcalnon/juniper-cascor --base main --head "$OLD_BRANCH" \
